...
public class NegativeRegistration extends BaseClass {

	@Test(priority = 1)
	public void firstNameMaxLengthChar() {
	...
	@Test(priority = 2)
	public void lastNameMaxLengthChar() {
	...
	@Test(priority = 4)
	public void passwordLess6Characters() {
	...
	@Test(priority = 5)
	public void passwordMore20Characters() {
